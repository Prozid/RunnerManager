...
namespace runnerManager
{
    ...
    partial void DeleteEstadoHilo(EstadoHilo instance);
		...
		public RunnerDBDataContext() : 
				base(global::runnerManager.Properties.Settings.Default.C__USERS_DANI_DOCUMENTS_VISUAL_STUDIO_2010_PROJECTS_RUNNERSVC_RUNNERSVC_RUNNERDB_MDFConnectionString, mappingSource)
		{
			OnCreated();
		}
